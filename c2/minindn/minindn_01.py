...
class Minindn(object):
    ...
    def __init__(self, parser=argparse.ArgumentParser(), topo=None, topoFile=None, noTopo=False,
        ...
        self.net.addLink( h1, s1, bw=0.1)
        self.net.addLink( h2, s2, bw=0.1)
        self.net.addLink( h3, s3, bw=0.1)
        self.net.addLink( h4, s4, bw=0.1)
        self.net.addLink( h5, s5, bw=0.1)
        self.net.addLink( h6, s6, bw=0.1)
        self.net.addLink( h7, s7, bw=0.1)
        self.net.addLink( h8, s8, bw=0.1)
        self.net.addLink( h9, s9, bw=0.1)
        self.net.addLink( h10, s10, bw=0.1)
        self.net.addLink( h11, s11, bw=0.1)
        self.net.addLink( h12, s12, bw=0.1)
        self.net.addLink( h13, s13, bw=0.1)
        self.net.addLink( h14, s14, bw=0.1)
        self.net.addLink( h15, s15, bw=0.1)
        self.net.addLink( h16, s16, bw=0.1)
        self.net.addLink( h17, s17, bw=0.1)
        self.net.addLink( h18, s18, bw=0.1)
        self.net.addLink( h19, s19, bw=0.1)
        self.net.addLink( h20, s20, bw=0.1)
        self.net.addLink( h21, s21, bw=0.1)
        self.net.addLink( h22, s22, bw=0.1)
        self.net.addLink( h23, s23, bw=0.1)
        self.net.addLink( h24, s24, bw=0.1)
        self.net.addLink( h25, s25, bw=0.1)
        self.net.addLink( h26, s26, bw=0.1)
        self.net.addLink( h27, s27, bw=0.1)
        self.net.addLink( h28, s28, bw=0.1)
        self.net.addLink( h29, s29, bw=0.1)
        self.net.addLink( h30, s30, bw=0.1)
        self.net.addLink( h31, s31, bw=0.1)
        self.net.addLink( h32, s32, bw=0.1)
        self.net.addLink( h33, s33, bw=0.1)
        self.net.addLink( h34, s34, bw=0.1)
        self.net.addLink( h35, s35, bw=0.1)
        self.net.addLink( h36, s36, bw=0.1)
        self.net.addLink( h37, s37, bw=0.1)
        self.net.addLink( h38, s38, bw=0.1)
        self.net.addLink( h39, s39, bw=0.1)
        self.net.addLink( h40, s40, bw=0.1)
        self.net.addLink( h41, s41, bw=0.1)
        self.net.addLink( h42, s42, bw=0.1)
        self.net.addLink( h43, s43, bw=0.1)
        self.net.addLink( h44, s44, bw=0.1)
        self.net.addLink( h45, s45, bw=0.1)
        self.net.addLink( h46, s46, bw=0.1)
        self.net.addLink( h47, s47, bw=0.1)
        self.net.addLink( h48, s48, bw=0.1)
        self.net.addLink( h49, s49, bw=0.1)
        self.net.addLink( h50, s50, bw=0.1)
        self.net.addLink( h51, s51, bw=0.1)
        self.net.addLink( h52, s52, bw=0.1)
        self.net.addLink( h53, s53, bw=0.1)
        self.net.addLink( h54, s54, bw=0.1)
        self.net.addLink( h55, s55, bw=0.1)
        self.net.addLink( h56, s56, bw=0.1)
        self.net.addLink( h57, s57, bw=0.1)
        self.net.addLink( h58, s58, bw=0.1)
        self.net.addLink( h59, s59, bw=0.1)
        self.net.addLink( h60, s60, bw=0.1)
        self.net.addLink( h61, s61, bw=0.1)
        self.net.addLink( h62, s62, bw=0.1)
        self.net.addLink( h63, s63, bw=0.1)
        self.net.addLink( h64, s64, bw=0.1)
        self.net.addLink( s1, s2, bw=0.1)
        self.net.addLink( s1, s12, bw=0.1)
        self.net.addLink( s1, s16, bw=0.1)
        self.net.addLink( s1, s22, bw=0.1)
        self.net.addLink( s2, s3, bw=0.1)
        self.net.addLink( s2, s11, bw=0.1)
        self.net.addLink( s2, s23, bw=0.1)
        self.net.addLink( s3, s4, bw=0.1)
        self.net.addLink( s3, s10, bw=0.1)
        self.net.addLink( s3, s24, bw=0.1)
        self.net.addLink( s4, s5, bw=0.1)
        self.net.addLink( s4, s9, bw=0.1)
        self.net.addLink( s4, s25, bw=0.1)
        self.net.addLink( s5, s6, bw=0.1)
        self.net.addLink( s5, s8, bw=0.1)
        self.net.addLink( s5, s26, bw=0.1)
        self.net.addLink( s6, s7, bw=0.1)
        self.net.addLink( s6, s27, bw=0.1)
        self.net.addLink( s7, s8, bw=0.1)
        self.net.addLink( s8, s9, bw=0.1)
        self.net.addLink( s9, s10, bw=0.1)        
        self.net.addLink( s10, s11, bw=0.1)
        self.net.addLink( s11, s12, bw=0.1)
        self.net.addLink( s12, s13, bw=0.1)
        self.net.addLink( s13, s16, bw=0.1)
        self.net.addLink( s13, s14, bw=0.1)
        self.net.addLink( s14, s15, bw=0.1)
        self.net.addLink( s15, s16, bw=0.1)
        self.net.addLink( s15, s18, bw=0.1)
        self.net.addLink( s16, s17, bw=0.1)
        self.net.addLink( s17, s20, bw=0.1)
        self.net.addLink( s17, s18, bw=0.1)
        self.net.addLink( s17, s22, bw=0.1)
        self.net.addLink( s18, s19, bw=0.1)
        self.net.addLink( s19, s42, bw=0.1)
        self.net.addLink( s19, s20, bw=0.1)
        self.net.addLink( s20, s21, bw=0.1)
        self.net.addLink( s20, s41, bw=0.1)
        self.net.addLink( s21, s22, bw=0.1)
        self.net.addLink( s21, s40, bw=0.1)
        self.net.addLink( s22, s23, bw=0.1)
        self.net.addLink( s23, s24, bw=0.1)
        self.net.addLink( s24, s25, bw=0.1)
        self.net.addLink( s25, s26, bw=0.1)
        self.net.addLink( s25, s30, bw=0.1)
        self.net.addLink( s26, s27, bw=0.1)
        self.net.addLink( s26, s29, bw=0.1)
        self.net.addLink( s27, s28, bw=0.1)
        self.net.addLink( s28, s33, bw=0.1)
        self.net.addLink( s28, s29, bw=0.1)
        self.net.addLink( s29, s30, bw=0.1)
        self.net.addLink( s29, s32, bw=0.1)
        self.net.addLink( s30, s31, bw=0.1)
        self.net.addLink( s31, s32, bw=0.1)
        self.net.addLink( s31, s36, bw=0.1)        
        self.net.addLink( s32, s33, bw=0.1)
        self.net.addLink( s32, s35, bw=0.1)
        self.net.addLink( s33, s34, bw=0.1)
        self.net.addLink( s34, s35, bw=0.1)
        self.net.addLink( s34, s55, bw=0.1)
        self.net.addLink( s35, s36, bw=0.1)
        self.net.addLink( s35, s54, bw=0.1)       
        self.net.addLink( s36, s37, bw=0.1)
        self.net.addLink( s36, s53, bw=0.1)
        self.net.addLink( s37, s52, bw=0.1)
        self.net.addLink( s37, s38, bw=0.1)
        self.net.addLink( s38, s39, bw=0.1)
        self.net.addLink( s38, s51, bw=0.1)
        self.net.addLink( s39, s40, bw=0.1)
        self.net.addLink( s39, s44, bw=0.1)
        self.net.addLink( s39, s50, bw=0.1)
        self.net.addLink( s40, s41, bw=0.1)
        self.net.addLink( s41, s42, bw=0.1)
        self.net.addLink( s41, s44, bw=0.1)
        self.net.addLink( s42, s43, bw=0.1)
        self.net.addLink( s43, s44, bw=0.1)
        self.net.addLink( s43, s46, bw=0.1)
        self.net.addLink( s44, s45, bw=0.1)
        self.net.addLink( s45, s46, bw=0.1)
        self.net.addLink( s45, s48, bw=0.1)
        self.net.addLink( s45, s50, bw=0.1)
        self.net.addLink( s46, s47, bw=0.1)
        self.net.addLink( s47, s48, bw=0.1)
        self.net.addLink( s48, s49, bw=0.1)
        self.net.addLink( s49, s50, bw=0.1)
        self.net.addLink( s49, s60, bw=0.1)
        self.net.addLink( s50, s51, bw=0.1)
        self.net.addLink( s51, s52, bw=0.1)
        self.net.addLink( s51, s60, bw=0.1)
        self.net.addLink( s52, s53, bw=0.1)
        self.net.addLink( s52, s59, bw=0.1)
        self.net.addLink( s53, s54, bw=0.1)
        self.net.addLink( s53, s58, bw=0.1)
        self.net.addLink( s54, s55, bw=0.1)
        self.net.addLink( s54, s57, bw=0.1)
        self.net.addLink( s55, s56, bw=0.1)
        self.net.addLink( s56, s57, bw=0.1)
        self.net.addLink( s57, s58, bw=0.1)
        self.net.addLink( s58, s59, bw=0.1)
        self.net.addLink( s59, s60, bw=0.1)
        self.net.addLink( s61, s31, bw=0.1)
        self.net.addLink( s61, s37, bw=0.1)
        self.net.addLink( s61, s62, bw=0.1)
        self.net.addLink( s61, s63, bw=0.1)
        self.net.addLink( s62, s38, bw=0.1)
        self.net.addLink( s62, s40, bw=0.1)
        self.net.addLink( s62, s64, bw=0.1)
        self.net.addLink( s63, s24, bw=0.1)
        self.net.addLink( s63, s30, bw=0.1)
        self.net.addLink( s63, s64, bw=0.1)
        self.net.addLink( s64, s21, bw=0.1)
        self.net.addLink( s64, s23, bw=0.1)     
        self.net.addLink( s100, h100, bw=0.1)
        self.net.addLink( s100, s10, bw=0.1)
        self.net.addLink( s100, s11, bw=0.1)
        self.net.addLink( s200, h200, bw=0.1)
        self.net.addLink( s200, s46, bw=0.1)
        self.net.addLink( s200, s48, bw=0.1)
        self.net.addLink( s300, h300, bw=0.1)
        self.net.addLink( s300, s28, bw=0.1)
        self.net.addLink( s300, s33, bw=0.1)
        self.net.addLink( s400, h400, bw=0.1)
        self.net.addLink( s400, s6, bw=0.1)
        self.net.addLink( s400, s8, bw=0.1)
