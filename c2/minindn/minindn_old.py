...
class Minindn(object):
    ...
    def __init__(self, parser=argparse.ArgumentParser(), topo=None, topoFile=None, noTopo=False,
        ...
        #self.net.addLink( s100, s2, bw=0.5, delay='10ms')
        self.net.addLink( s200, h200, bw=0.5)
        #self.net.addLink( s200, s28, bw=0.5, delay='10ms')
        self.net.addLink( s200, s30, bw=0.5, delay='10ms')
        self.net.addLink( s300, h300, bw=0.5)
        #self.net.addLink( s300, s20, bw=0.5, delay='10ms')
        self.net.addLink( s300, s21, bw=0.5, delay='10ms')
        self.net.addLink( s400, h400, bw=0.5)
        #self.net.addLink( s400, s4, bw=0.5, delay='10ms')
        self.net.addLink( s400, s6, bw=0.5, delay='10ms')
